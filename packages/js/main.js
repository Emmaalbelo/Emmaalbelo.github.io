...
function toggleSkills() {
  ...
  if (itemClass === "skills__content skills__close") {
    ...
    const skillsPercentage = this.nextElementSibling.querySelectorAll(
      ".skills__percentage"
    );
    skillsPercentage.forEach((percentage) => {
      percentage.style.animation = "none";
      void percentage.offsetWidth; // Trigger reflow
      percentage.style.animation = "animate 4s ease-in-out forwards";
    });
  }
}
